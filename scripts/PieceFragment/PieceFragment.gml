...
//
//
function PieceFragment(_t, isWhite, sourcex, sourcey, _x, _y, _w, _h, spread) constructor {
	...
	x = sourcex*spread - sprite_get_xoffset(spr) + _x;
	y = sourcey*spread;
	...
	static draw = function(xoff, yoff, spread) {
